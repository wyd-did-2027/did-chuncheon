...
export const content = {
  kr: {
    lang: "ko",
    metadata: {
      title: "WYD SEOUL 2027 DID 춘천",
      description: "WYD SEOUL 2027 DID 춘천 공식 웹사이트",
      ogLocale: "ko_KR",
    },
    header: {
  ...
  en: {
    ...
    metadata: {
      ...
      description: "WYD SEOUL 2027 DID Chuncheon Official Website",
      ogLocale: "en_US",
    },
    header: {
